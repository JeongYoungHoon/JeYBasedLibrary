package com.jey_dev.lib.jeybasedlibrary.view;
...
import com.jey_dev.lib.jeybasedlibrary.R;
import com.jey_dev.lib.jeybasedlibrary.util.JUtil;
...
public class JPagerIndicatorView extends LinearLayout {
    ...
    private void initView(){
        ...
        final int normalSize= JUtil.dpToPx(ctx,10);
        final int smallSize= JUtil.dpToPx(ctx,5);
        final int bigSize= JUtil.dpToPx(ctx,20);
        int size=normalSize;
